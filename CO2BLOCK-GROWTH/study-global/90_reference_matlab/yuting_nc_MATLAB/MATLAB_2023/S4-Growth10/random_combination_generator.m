...
Rr =  0.01 + (0.1-0.01)*rand(1,10000); 
%Rr = 0.1345; % single growth rate 


target_s = 0.001 + (0.0498-0.001)*rand(1, 10000); % % change
...
todelete1 = T.Storage >= 17.672;% change
T(todelete1,:) = [];
size(T);
...
T(todelete4,:) = [];
size(T);
writetable(T, 'MiddleEast.txt') % change
