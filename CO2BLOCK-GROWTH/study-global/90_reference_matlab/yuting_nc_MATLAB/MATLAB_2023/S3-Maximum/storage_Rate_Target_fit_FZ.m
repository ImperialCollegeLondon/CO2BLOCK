...
start_q = 0.071; % cumulative storage in 2030 = Q(2030) - known 2 
target_year = 2050; % t2050
target_s = [0.74]; %storage rate in 2050 = Q(2050) i.e. 298 Mt/year in 2050 1.5Tech target - known 3 
...
Qr = [logspace(log10(1.1), log10(10000),4000)]; 
