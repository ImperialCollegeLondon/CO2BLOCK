...
%target_s = repmat(0.2146,7000,1); % defined target 
target_s = 0.001 + (1.28-0.001)*rand(1, 10000); % generating random targets between the maximum target defined by upper bounds of growth and storage resource availability
...
T(todelete4,:) = [];
size(T);
writetable(T, 'Canada.txt') % change
