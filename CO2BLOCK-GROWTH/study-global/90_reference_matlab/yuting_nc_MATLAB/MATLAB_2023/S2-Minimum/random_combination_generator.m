...
Rr =  0.01 + (0.25-0.01)*rand(1,10000); 
%Rr = 0.1345; % single growth rate 


target_s = 0.001 + (1.5-0.001)*rand(1, 10000); % % change
...
todelete1 = T.Storage >= 4030;% change
T(todelete1,:) = [];
size(T);
