...
start_q = 0.1102; % cumulative storage in 2030 = Q(2030) - known 2 
target_year = 2050; % t2050
target_s = [0.176]; %storage rate in 2050 = Q(2050) i.e. 298 Mt/year in 2050 1.5Tech target - known 3 
...
Qr = [logspace(log10(1), log10(10000),4000)]; 
