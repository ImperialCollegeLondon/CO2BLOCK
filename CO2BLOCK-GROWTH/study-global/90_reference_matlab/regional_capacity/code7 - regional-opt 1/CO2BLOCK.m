...
fname = 'Global.xlsx';        % name of the input data file
%-

%-- setting parameters
nr_region = 203;                     % number of storage regions in the input file
...
writetable(Regional_storage_summary_table,['Regional_storage_summary_minQ=',num2str(minQ),'_',num2str(time_yr),'y_Anadarko','.xls']);
