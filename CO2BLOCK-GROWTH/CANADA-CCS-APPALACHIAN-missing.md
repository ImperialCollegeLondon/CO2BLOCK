...
|-----------|-----------|--------------|-----------------|
| St. Lawrence Lowlands (QC) | ✅ Fringe | 0 projects; assessments | Not separately listed (see `CANADA-CCS-ST_LAWRENCE_LOWLANDS-missing.md`) |
...
| **US Appalachian CCS** (CAB-CS, Ohio) | Not Canadian, but relevant cross-border context |
